		...
		<div class="rpgui-container framed-golden-2">
			...
			<div class="portfolio-contact-links">
				<a
					...
					class="rpgui-container framed-grey portfolio-contact-row"
				>
					<span class="portfolio-contact-icon" aria-hidden="true">@</span>
					<span>Email</span>
				</a>
				<a
					...
					class="rpgui-container framed-grey portfolio-contact-row"
				>
					<span class="portfolio-contact-icon" aria-hidden="true">in</span>
					<span>LinkedIn</span>
				</a>
				<a
